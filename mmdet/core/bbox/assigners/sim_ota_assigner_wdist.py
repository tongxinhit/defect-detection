...
from ..iou_calculators import bbox_overlaps, wasserstein_dist
from .assign_result import AssignResult
from .base_assigner import BaseAssigner


@BBOX_ASSIGNERS.register_module()
class SimOTAAssigner_dist(BaseAssigner):
    ...
    def _assign(self,
        ...
        pairwise_ious = wasserstein_dist(valid_decoded_bbox, gt_bboxes)
        # print(pairwise_ious.sum())
