...
def wasserstein_dist(pred, target, eps=1e-7, mode='exp', gamma=1, constant=12.8):
    ...
    whs = center1[:,None, :2] - center2[None,:, :2]
    # print(whs.shape)
    ...
    wh_distance = ((w1[:,None] - w2[None,:]) ** 2 + (h1[:,None] - h2[None,:]) ** 2) / 4
    # print(wh_distance.shape)
