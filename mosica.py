...
def get_random_data(image_list, input_shape):
    ...
    for image, boxes in zip(image_datas, box_datas):
        ...
        cv2.imwrite('/home/tongxin/dataaugument/for-mosica/image_copy.jpg',image_copy)
    ...
    cv2.imwrite('/home/tongxin/dataaugument/for-mosica/new_image.jpg',new_image)
    # 显示合并后的图像
    ...
    cv2.imwrite('/home/tongxin/dataaugument/for-mosica/final_image_copy.jpg',final_image_copy)
    ...
    cv2.imwrite('/home/tongxin/dataaugument/for-mosica/modify_image_copy.jpg',modify_image_copy)
...
if __name__ == '__main__':
    ...
    # 给出图片文件夹和检测框文件夹所在的位置
    image_dir = "/home/tongxin/dataaugument/for-mosica/pic/"
    annotation_dir = "/home/tongxin/dataaugument/for-mosica/ann/"
