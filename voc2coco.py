...
path2 = "/home/tongxin/three_detect_COCO/" # 输出文件夹
...
classes=['hole','incision','scorched','cuts']
xml_dir = "/home/tongxin/defects_voc/" # xml文件
img_dir = "" # 图片
...
if __name__ == '__main__':
    ...
    save_json_train = path2 + 'annotations/train2017.json'
    save_json_val = path2 + 'annotations/val2017.json'
